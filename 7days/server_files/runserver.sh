...
if [ "$(uname -m)" = "x86_64" ]; then
	./7DaysToDieServer.x86_64 -logfile console.log -quit -batchmode -nographics -dedicated $PARAMS
else
	./7DaysToDieServer.x86 -logfile console.log -quit -batchmode -nographics -dedicated $PARAMS
fi
